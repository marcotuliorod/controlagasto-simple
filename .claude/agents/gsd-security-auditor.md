...
**Verification depth scales with `asvs_level`** (see @/Users/marcotuliorodgmail.com/Library/Mobile Documents/com~apple~CloudDocs/Projetos/Controla_Gastos_Simples/controlagasto-simple/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
